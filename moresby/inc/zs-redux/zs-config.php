...
/*    $opt_name = apply_filters( 'zs_store/opt_name', $opt_name );*/
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Moresby', 'zs' ),
        'page_title'           => __( 'Moresby', 'zs' ),
    ...
    // Panel Intro text -> before the form
        $args['intro_text'] = __( '<p>Moreby Options</p>', 'zs' );
    ...
    Redux::setSection( $opt_name, array(
    'title'     => esc_html__( 'Plan', 'zs' ),
    'icon'      => 'fa fa-edit',
    'fields'    => array(
        array(
            'id'        => 'plan_general_info_start',
            'type'      => 'section',
            'title'     => esc_html__( 'General', 'zs' ),
            'subtitle'  => esc_html__( 'Plan Section Style Settings', 'zs' ),
            'indent'    => TRUE,
        ),

        array(
            'title'     => esc_html__( 'Use a Plan predefined color scheme', 'zs' ),
            'on'        => esc_html__('Yes', 'zs'),
            'off'       => esc_html__('No', 'zs'),
            'type'      => 'switch',
            'default'   => 1,
            'id'        => 'use_button_predefined_color'
        ),

        array(
            'title'     => esc_html__( 'Default Plan Button Color', 'zs' ),
            'subtitle'  => esc_html__( 'The plan button color of the site.', 'zs' ),
            'id'        => 'plan_main_color',
            'type'      => 'select',
            'options'   => array(
                'plan_default_theme_color'         => esc_html__( 'Default Theme color', 'zs' ),
            ),
            'default'   => 'plan_default_theme_color',
            'required'  => array( 'use_button_predefined_color', 'equals', 1 ),
        ),

          array(
            'id'        => 'plan_1_color_start',
            'type'      => 'section',
            'title'     => esc_html__( 'Plan 1 Button Color', 'zs' ),
            'indent'    => TRUE,
            'required'    => array( 'use_button_predefined_color', 'equals', 0 ),
        ),

        array(
            'id'          => 'plan_1_button_color',
        ...
        array(
            'id'          => 'plan_1_button_text_hover_color',
        ...
        array(
          ...
          array(
            'id'        => 'plan_2_color_start',
            'type'      => 'section',
            'title'     => esc_html__( 'Plan 2 Button Color', 'zs' ),
            'indent'    => TRUE,
            'required'    => array( 'use_button_predefined_color', 'equals', 0 ),
        ),

        array(
            'id'          => 'plan_2_button_color',
            'title'       => esc_html__( 'Button Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#36ae44',
        ...
        array(
            'id'          => 'plan_2_button_text_hover_color',
            'title'       => esc_html__( 'Button Text Hover Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#fff',
        ...
        array(
          ...
          array(
            'id'        => 'plan_3_color_start',
            'type'      => 'section',
            'title'     => esc_html__( 'Plan 3 Button Color', 'zs' ),
            'indent'    => TRUE,
            'required'    => array( 'use_button_predefined_color', 'equals', 0 ),
        ),

        array(
            'id'          => 'plan_3_button_color',
            'title'       => esc_html__( 'Button Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#01adef',
        ...
        array(
            'id'          => 'plan_3_button_text_hover_color',
            'title'       => esc_html__( 'Button Text Hover Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#fff',
    ...
    Redux::setSection( $opt_name, array(
    'title'     => esc_html__( 'Service', 'zs' ),
    'icon'      => 'fa fa-edit',
    'fields'    => array(
        array(
            'id'        => 'service_general_info_start',
            'type'      => 'section',
            'title'     => esc_html__( 'General', 'zs' ),
            'subtitle'  => esc_html__( 'Service Section Style Settings', 'zs' ),
            'indent'    => TRUE,
        ),

        array(
            'title'     => esc_html__( 'Use a Service predefined color scheme', 'zs' ),
            'on'        => esc_html__('Yes', 'zs'),
            'off'       => esc_html__('No', 'zs'),
            'type'      => 'switch',
            'default'   => 1,
            'id'        => 'use_service_button_predefined_color'
        ),

        array(
            'title'     => esc_html__( 'Default Service Button Color', 'zs' ),
            'subtitle'  => esc_html__( 'The Service button color of the site.', 'zs' ),
            'id'        => 'service_main_color',
            'type'      => 'select',
            'options'   => array(
                'service_default_theme_color'         => esc_html__( 'Default Theme color', 'zs' ),
            ),
            'default'   => 'service_default_theme_color',
            'required'  => array( 'use_service_button_predefined_color', 'equals', 1 ),
        ),

          array(
            'id'        => 'service_1_color_start',
            'type'      => 'section',
            'title'     => esc_html__( 'Service 1 Button Color', 'zs' ),
            'indent'    => TRUE,
            'required'    => array( 'use_service_button_predefined_color', 'equals', 0 ),
        ),

        array(
            'id'          => 'service_1_button_color',
            'title'       => esc_html__( 'Button Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#e41b2b',
        ...
        array(
            'id'          => 'service_1_button_text_color',
            'title'       => esc_html__( 'Button Text Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#fff',
        ...
        array(
            'id'          => 'service_1_button_hover_color',
            'title'       => esc_html__( 'Button Hover Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#274397',
        ...
        array(
            'id'          => 'service_1_button_text_hover_color',
            'title'       => esc_html__( 'Button Text Hover Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#fff',
        ...
        array(
          ...
          array(
            'id'        => 'service_2_color_start',
            'type'      => 'section',
            'title'     => esc_html__( 'Service 2 Button Color', 'zs' ),
            'indent'    => TRUE,
            'required'    => array( 'use_service_button_predefined_color', 'equals', 0 ),
        ),

        array(
            'id'          => 'service_2_button_color',
            'title'       => esc_html__( 'Button Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#36ae44',
        ...
        array(
            'id'          => 'service_2_button_text_color',
            'title'       => esc_html__( 'Button Text Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#fff',
        ...
        array(
            'id'          => 'service_2_button_hover_color',
            'title'       => esc_html__( 'Button Hover Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#274397',
        ...
        array(
            'id'          => 'service_2_button_text_hover_color',
            'title'       => esc_html__( 'Button Text Hover Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#fff',
        ...
        array(
          ...
          array(
            'id'        => 'service_3_color_start',
            'type'      => 'section',
            'title'     => esc_html__( 'Service 3 Button Color', 'zs' ),
            'indent'    => TRUE,
            'required'    => array( 'use_service_button_predefined_color', 'equals', 0 ),
        ),

        array(
            'id'          => 'service_3_button_color',
            'title'       => esc_html__( 'Button Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#01adef',
        ...
        array(
            'id'          => 'service_3_button_text_color',
            'title'       => esc_html__( 'Button Text Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#fff',
        ...
        array(
            'id'          => 'service_3_button_hover_color',
            'title'       => esc_html__( 'Button Hover Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#274397',
        ...
        array(
            'id'          => 'service_3_button_text_hover_color',
            'title'       => esc_html__( 'Button Text Hover Color', 'zs' ),
            'type'        => 'color',
            'transparent' => false,
            'default'     => '#fff',
    ...
    'fields'    => array(
        ...
        array(
            ...
            'default'   => '© 2019 moresbychildcare.org.au',
