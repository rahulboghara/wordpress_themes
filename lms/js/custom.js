...
jQuery(document).ready(function(){
    ...
    jQuery("#lms_plan_section #lms_plan_inner").each(function () {
            jQuery(this).wrapInner(" <div class='plan_content_inner'> </div>");
        });
    jQuery(".lms_services #lms_services_img").each(function () {
            jQuery(this).wrapInner(" <div class='lms_services_img_inner'> </div>");
        });
    jQuery(".lms_popularcat #lms_popularcat-content").each(function () {
