...
require_once get_template_directory() . '/inc/zs-redux/functions/blog-functions.php';
...
require_once get_template_directory() . '/inc/zs-redux/functions/shop-functions.php';
